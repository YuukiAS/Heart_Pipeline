...
class network_trainer_2d(object):
    ...
    def train(self, epoch):
        ...
        for batch_idx, (x, y) in enumerate(self.train_dataloader):
            ...
            print(
                "Train Epoch: {}({}/{})]\tLoss: {:.6f}\t multi_class_dice_coef: {:.6f}".format(
                    epoch, n_processed, len(self.train_dataloader), avg_loss, dsc
                )
            )
    ...
    def test(self):
        ...
        avg_dsc = 100.0 * correct / n_processed
