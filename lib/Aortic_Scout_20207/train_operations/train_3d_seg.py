...
def perform_training():
    ...
    train_patch_generator = patch_dataloader(
        train_dataset,
        config.patch_size,
    ...
    validation_patch_generator = patch_dataloader(
        validation_dataset,
        config.patch_size,
        config.patches_per_image,
        config.label_probabilities,
    ...
    validation_dataloader = torch.utils.data.DataLoader(
        validation_patch_generator, batch_size=config.batch_size, pin_memory=True
    )
