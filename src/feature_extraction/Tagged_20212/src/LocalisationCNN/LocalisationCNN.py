...
class LocalisationCNN:
    ...
    def __init__(self, initial_learning_rate=1e-3, training_keep_prob=0.8):
        ...
        self.optimizer = tf.keras.optimizers.Adam(learning_rate=self.learning_rate, name="optimizer")
    ...
    def build_network(self, input_x, output_size, is_training, keep_prob=0.8):
        ...
        with tf.compat.v1.variable_scope("layer3"):
            ...
            conv3 = tf.keras.layers.BatchNormalization()(conv3, training=is_training)
        ...
        with tf.compat.v1.variable_scope("layer4"):
            ...
            conv4 = tf.keras.layers.BatchNormalization()(conv4, training=is_training)
        ...
        with tf.compat.v1.variable_scope("layer5"):
            ...
            conv5 = tf.keras.layers.BatchNormalization()(conv5, training=is_training)
        ...
        flattened = tf.reshape(pool5, [-1, pool5.shape[1] * pool5.shape[2] * 32])

        with tf.compat.v1.variable_scope("dense1"):
            dense1 = tf.keras.layers.Dense(1024, activation=tf.nn.relu, use_bias=True)(flattened)
        ...
        with tf.compat.v1.variable_scope("dense2"):
            ...
            dense2 = tf.keras.layers.Dense(output_size, activation=None, use_bias=True)(dense1)
